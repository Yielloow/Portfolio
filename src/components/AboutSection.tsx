    ...
    <section id="about" className="py-24 px-6">
      <div className="max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">{t("about.title_start")}<span className="text-gradient">{t("about.title_highlight")}</span></h2>
          <p className="text-muted-foreground text-lg max-w-2xl leading-relaxed mb-16">{desc}</p>
        </motion.div>
